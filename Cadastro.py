...
root.grid_columnconfigure(0, weight=1)
#Label do 1º Frame:
lb0_fr1 = Label(fr1, text='Dados Pessoais', font='Arial 25', padx=15, pady=10)
lb1_fr1 = Label(fr1, text='Nome:', font='Arial 25', padx=15, pady=10)
lb2_fr1 = Label(fr1, text='Data Nasc.:', font='Arial 25', padx=15, pady=10)
lb3_fr1 = Label(fr1, text='CPF:', font='Arial 25', padx=15, pady=10)
lb4_fr1 = Label(fr1, text='Telefone:', font='Arial 25', padx=15, pady=10)
#Entry do 1º Frame:
...
lb0_fr1.grid(row=0, column=0, sticky=W)
...
#Label do 2º Frame:
lb0_fr2 = Label(fr2, text='Endereço', font='Arial 25', padx=15, pady=10)
lb1_fr2 = Label(fr2, text='Rua:', font='Arial 25', padx=15, pady=10)
lb2_fr2 = Label(fr2, text='Bairro:', font='Arial 25', padx=15, pady=10)
lb3_fr2 = Label(fr2, text='Cidade:', font='Arial 25', padx=15, pady=10)
lb4_fr2 = Label(fr2, text='Nº:', font='Arial 25', padx=15, pady=10)
lb5_fr2 = Label(fr2, text='UF:', font='Arial 25', padx=15, pady=10)
#Entry do 2º Frame:
...
lb0_fr1.grid_rowconfigure(0, weight=1)
lb0_fr1.grid_columnconfigure(0, weight=1)
...
lb0_fr2.grid_rowconfigure(0, weight=1)
lb0_fr2.grid_columnconfigure(0, weight=1)
