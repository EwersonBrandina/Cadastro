...
lb1_fr1.grid(row=1, column=0, sticky=E)
lb2_fr1.grid(row=2, column=0, sticky=E)
lb3_fr1.grid(row=3, column=0, sticky=E)
lb4_fr1.grid(row=4, column=0, sticky=E)
#Posição dos Entry do 1º Frame:
in1_fr1.grid(row=1, column=1, columnspan= 3)
in2_fr1.grid(row=2, column=1, sticky=E)
in3_fr1.grid(row=3, column=1, sticky=E)
in4_fr1.grid(row=4, column=1, sticky=E)
#Label do 2º Frame:
...
lb1_fr2.grid(row=1, column=0, sticky=E)
lb2_fr2.grid(row=2, column=0, sticky=E)
lb3_fr2.grid(row=2, column=2, sticky=E)
lb4_fr2.grid(row=1, column=4, sticky=E)
lb5_fr2.grid(row=2, column=4, sticky=E)
#Posição dos Entry do 2º Frame:
in1_fr2.grid(row=1, column=1, columnspan= 3, sticky=NSEW)
in2_fr2.grid(row=2, column=1, sticky=E)
in3_fr2.grid(row=2, column=3, sticky=E)
in4_fr2.grid(row=1, column=5, sticky=E)
in5_fr2.grid(row=2, column=5, sticky=E)
